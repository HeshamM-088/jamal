        ...
        <div className="">
          ...
          <div className="md:grid md:grid-cols-8">
            <div className="col-span-6 col-end-7">
              <MovieDetailsBody creditsDetails={movieCreditsDetailsdata} />
              <SocialMovieDetails movieid={movieid} />
              <MediaMovieDetails movieid={movieid} />
              <PartOfCollection
                movieid={movieid}
                // collectionsid={collectionsid}
              />
              <MovieDetailsRecommendations movieid={movieid} />
            </div>
            <div className=" col-start-7 col-end-13">
              <MovieDetailsSidBar movieid={movieid} />
            </div>
          </div>
        </div>
      )}
